        ...
        public static async Task SeedArticlesAsync(IArticleService articleService)
        {
            var sampleArticles = new[]
            {
                new CreateArticleRequest
                {
                    ...
                    ArticleCategory = "Hub",
                    BicycleCategories = new List<string> { "Mountain", "e-Cargo bike" },
                    Material = "Aluminum",
                    LengthMm = 135,
                    WidthMm = 32,
                    HeightMm = 32,
                ...
                new CreateArticleRequest
                {
                    ...
                    ArticleCategory = "Hub",
                    BicycleCategories = new List<string> { "Road", "Gravel" },
                ...
                new CreateArticleRequest
                {
                    ...
                    BicycleCategories = new List<string> { "Mountain", "e-Trekking" },
                    Material = "Aluminum",
                    LengthMm = 175,
                    WidthMm = 24,
                    HeightMm = 24,
                ...
                new CreateArticleRequest
                {
                    ...
                    ArticleCategory = "Crank arm",
                    BicycleCategories = new List<string> { "Road", "e-Gravel" },
                    Material = "Aluminum",
                    LengthMm = 172.5m,
                    WidthMm = 24,
                    HeightMm = 24,
                ...
                new CreateArticleRequest
                {
                    ...
                    BicycleCategories = new List<string> { "Road", "e-City" },
                    Material = "Carbon Fiber",
                    LengthMm = 622,
                    WidthMm = 25,
                    HeightMm = 25,
                ...
                new CreateArticleRequest
                {
                    ...
                    ArticleCategory = "Wheel",
                    BicycleCategories = new List<string> { "Mountain", "Foldable" },
                    Material = "Aluminum",
                    LengthMm = 622,
                    WidthMm = 30,
                    HeightMm = 30,
